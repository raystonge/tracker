$(document).ready(function () {
	...
	link = "/ajax/userProfile/listAvailableModules.php";
	...
	{
	  link = "/ajax/userProfile/listMyModules.php";
	...
	function initMyMods()
	{
	    $("#myModules ul").sortable({
	        ...
	        update: function () {
	         ...
	         // $.post("/ajax/userProfile/resortModules.php", order, function (data) {});
		...
		$(".myMods").droppable({
	        ...
	        drop: function (event, ui) {
	            link = "/ajax/userProfile/addModule.php";
	    ...
	    $('.r_delete').bind('click', function () {
	        link = "/ajax/userProfile/deleteModule.php";
	        itemToRemove = $(this);
