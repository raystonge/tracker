...
$(document).ready(function () {
    $("#search").submit(function () {
    	...
    	linkSearch = "/ajax/results/assets/searchAssetToAsset.php";
        link = "/ajax/results/assets/assetSoftware.php";
    ...
    function AddAsset()
    {
        ...
        {
    	  var formData = $(":input").serializeArray();
          var link = "/process/addAssetSoftware.php";
    	  $.post(link,formData,function (theResponse){
			  $('#search').submit();
          });
        });
    ...
    function RemoveAsset()
    {
        ...
        {
    	  var formData = $(":input").serializeArray();
          var link = "/process/removeAssetSoftware.php";
    	  $.post(link,formData,function (theResponse){
			  $('#search').submit();
          });
        });
