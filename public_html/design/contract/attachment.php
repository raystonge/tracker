...
<form method="post" autocomplete="<?php echo $autoComplete;?>" enctype="multipart/form-data" action="/process/contract/attachment.php">
<table>
...
$param = AddEscapedParam("","contractId",$contract->contractId);
