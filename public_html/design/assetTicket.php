...
if (!$permission->hasPermission("Asset: View Tickets"))
{
	            ...
	            <div class="nav-collapse collapse">
	              <div class="menu-main-container">
	                <ul id="menu-main" class="nav">
	                  <li id="menu-item-ifeature-home" class="menu-item menu-item-type-custom menu-item-object-custom">
	                    <a href='/editTicket/<?php echo $ticketId;?>/' title='Ticket'><span>Ticket</span></a>
	                  </li>
	                  <li id="menu-item-20" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-20 active"><a href='/assetTicket/<?php echo $ticketId;?>/' title='Assets'><span>Assets</span></a></li>
