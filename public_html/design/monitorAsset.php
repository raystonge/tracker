...
if (!$permission->hasPermission("Asset: Monitor"))
{
	            ...
	            <div class="nav-collapse collapse">
	              <div class="menu-main-container">
	                <ul id="menu-main" class="nav">
	                  ...
	                  <li id="menu-item-20" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-20 active"><a href='/monitorAsset/<?php echo $assetId;?>/' title='Monitor'><span>Monitor</span></a></li>
